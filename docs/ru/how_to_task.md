...
**Заявка** — сущность, необходимая для работы с номенклатурой в пространстве. Это драфт документа списания оборудования со склада или поступления оборудования на склад. Заявка формирует перечень событий в мероприятии, которые выполняются последовательно разными контрагентами. 

С заявкой работают:
- автор — тот, кто создает заявку и заполняет основную информацию, таким правом обладает менеджер или руководитель склада;
- ответственный — назначает исполнителей по заявке, эта возможность есть только у руководителя склада, назначаемого автоматически в соответствии с указанным в договоре пространством;
- исполнитель — тот, кто выполняют работы по задачам внутри заявки, может быть несколько исполнителей по одной заявке.

Также у заявки есть тип: «поступление», «списание» или «инвентаризация». 
В зависимости от этого типа отличаются задачи и та информация, которая указывается при создании.

## 1. Заполнение информации по заявке

Выполняет либо руководитель склада, либо автор заявки.

Из подсистемы «Мероприятия» по команде «Создать мероприятие» выберите «Работа склада». В открывшейся форме определите тип заявки и заполните необходимую информацию.  
