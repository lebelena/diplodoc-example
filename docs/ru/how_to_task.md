...
- Списание
  ...
  Из списка мероприятий контрагент, назначенный исполнителем, открывает заявку.
  Перед стартом мероприятия проверьте общую информацию и информацию о поставщике, перевозчике, получателе — это необходимо, чтобы удостовериться действительно ли ту заявку вы взяли в работу.  
