...
**Заявка** — это документ, который необходим для работы с номенклатурой внутри компании. Заявка состоит из задач, которые выполняются последовательно разными контрагентами. 
