...
**[Поручение][1]** — элемент управления, являющийся высокоуровневым указанием от клиента на выполнение услуг. Поручение **всегда создается в рамках договора**, поэтому для создания поручения необходимо в начале открыть договор, которому создаваемое поручение будет подчинено. 
