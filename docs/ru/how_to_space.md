...
На [текущей странице](*key_space) описан алгоритм создания пространства из справочника. 
...
Топология задается только из справочника. Если пространства создавались из любой другой части системы, то по умолчанию в топологии будет только зона погрузки. Редактирование топологии возможно по клику верхнеуровнево для системного пространства, подчиненные пользовательские пространства наследуют топологию у системного. 
...
[*key_space]: Алгоритм практически одинаков, но имеет небольшие отличия для разных точек входа. Особенности при создании [контрагента](./how_to_counterparty.md) и [заказов](./how_to_request.md) описаны на соответствующих страницах руководства. 