...
- ИП
  ...
  Введите ИНН и нажмите на значок лупы. Автоматически заполнится информация о ФИО и ОГРНИП. Дату регистарции ИП, а также паспортные данные необходимо внести вручную.
...
- Юридическое лицо
  ...
  Данные можно заполнить автоматически. 
  Введите ИНН и нажмите на значок лупы. Система подгрузит актуальные данные из ЕГРЮЛ. Дполнительную информацию (при наличии) необходимо ввести вручную.
