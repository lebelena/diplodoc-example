...
**Шаг 1.** Создать контрагента можно из раздела «Справочники» → «Контрагенты» → команада «Создать контрагента» или из раздела «Мероприятия» → команда «Создать мероприятия» → «Новый контрагент».
