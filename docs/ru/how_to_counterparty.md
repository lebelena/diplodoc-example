...
**Контрагент** — это любое юридическое или физическое лицо, зарегистрированное в системе.
...
Добавление пространства происходит в 2 этапа: создание или выбор существующего системного пространства, далее — работа с пользовательскими пространствами. Подробнее о видах пространств можно прочитать в [соответствующем разделе](./how_to_space.md) руководства.

#### Системное пространство  

Системное пространство служит для группировки пользовательских пространств (фактически существующих объектов). У пространства есть топология и подчиненные пользовательские пространства. 
...
Добавить системное пространство можно двумя способами: создать новое пространство или выбрать существующее пространство из справочника. 
...
При необходимости можно оставить комментарий и прикрепить файлы. Они будут доступны отделу делопроизводства, который продолжит работу по мероприятию создания контрагента. Комментарий и файлы привязаны к мероприятию по созданию контрагента и видны только сотрудникам делопроизводства. Больше комментарии нигде не отображаются.

![screenshot_101](_images/_screen_101.png){width=1200}
...
Экран можно разделить на три блока: вкладки с данными контрагента (1), центральная область, наполнение которой зависит от выбранной вкладки (2), и блок с фото и основной информацией о контрагенте (3).

### **Фото и основная информация**

![_screen_doc_edit](_images/_screen_card_info_about.png){.center width=1200}

**Кнопка с карандашом в правом верхнем углу** позволяет загрузить фото для контрагента, а также отредактировать информацию в остальных полях. 

Также ниже **расположены две команды для документов контрагента:** с их помощью можно загрузить новый документ или скачать ранее загруженный. 

{% note warning %}

Удалить документ без загрузки нового нельзя. 
...
![_screen_doc_edit](_images/_screen_card_docs_info.png){.center width=1200}

Если по договору есть активные поручения, они отразятся в правом углу: на рисунке запись 2/7 означает два активных поручения из семи существующих. 

Сам договор можно расторгнуть по команде «Расторгнуть» или открыть для просмотра по команде «Открыть». В открывшейся форме договора доступно редактирование, скачивание прикреплённых файлов и добавление поручений.

![_screen_doc_edit](_images/_screen_doc_edit.png){.center width=1200}

На вкладке «Поручения» открывшейся формы договора можно добавить новое поручение по выбранному договору, открыть или отредактировать уже имеющиеся активные поручения, а также перейти к заказу в рамках этого поручения. Работа с поручениями описана в [руководстве пользователя «Поручение»](./how_to_assignment.md).

![_screen_assign](_images/_screen_assign.png){.center width=1200}

### **Вкладка «Банковские реквизиты»**

Отображаются банковские реквизиты, относящиеся к выбранному контрагенту.

![_screen_card_count_doc](_images/_screen_card_bank_account.png){.center width=1200}

Если счетов много, информацию о них можно отфильтровать по статусу счета (активный/неактивный) и банку, где хранится счет. Также, если известен номер счета, можно искать банковские реквизиты по нему.
...
При необходимости можно добавить новый счет по команде «Добавить».

### **Вкладка «Пространства»**

Здесь находится информация о всех пространствах контрагента. 

![_screen_card_count_places](_images/_screen_card_count_places.png){.center width=1200}

Если пространств много, информацию о них можно отфильтровать по типу (юридический адрес, офис, склад, торговая точка) и статусу (активное или неактивное). Также можно найти пространство через поисковую строку, если известен адрес объекта.

### **Вкладка «Автопарк»**

Включает перечень всего транспорта, закреплённого за контрагентом

![_screen_card_count_places](_images/_screen_card_autopark.png){.center width=1200}

В блоке «Автопарк» можно:
* добавить новое транспортное средство → указывается марка, модель, госномер, вид транспорта (легковое транспортное средство, грузопассажирское, пеший etc.) и загружается при наличии фото;
* изменить информацию по уже закрепленному транспорту;
* удалить информацию о транспортном средстве, если оно больше не используется.

{% note tip %}

Если транспортных средств много, список можно отфильтровать по виду транспорта или найти конкретный автомобиль по марке, модели или госномеру в поисковой строке.
