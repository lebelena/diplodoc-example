...
Если работа с контрагентом была прекращена, нажмите «Деактивировать». Таким образом сохранятся все документы и операции с данным контрагентом, но выбрать в новых мероприятиях его будет нельзя.   
...
Активные счета — те счета, которые использует контрагент, неактивные — те, которые когда-то использовались при расчетах. Неактивный счет нельзя использовать в банковских операциях, но можно просмотреть историю операций, которая была по этому счету.  
...
Отображаются все пространтсва контрагента. 
Если пространств много, информацию о них можно отфильтровать по типу пространства (юридический адрес/офис/склад/торговая точка) и статусу (активное/неактивный). 
...
Также если вы знаете адрес объекта, можно найти пространство через поисковую строку.     
